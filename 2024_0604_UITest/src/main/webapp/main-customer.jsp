...
<body>
	<div id="main-box">
		...
		<div id="content">
			<!-- 고객센터 -->
			<!-- menu == 'inquiry' --> <!--  submenu-company.jsp에서 -> a태그 menu 대로 써야된다. -->
			<c:if test="${ (empty param.menu) or param.menu == 'inquiry'}"> <!-- 비어있으면 -->
				<%@include file="content/customer/inquiry.jsp" %>
			</c:if>
			
			
			<!-- menu == 'qna' -->
			<c:if test="${ param.menu == 'qna'}">
